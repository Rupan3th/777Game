...
<body >
    <form id="form1" runat="server">
        <table id="main_tbl" cellpadding="1" cellspacing="0" style="width: 100%; text-align: center; border-collapse: collapse;">
            <tr>
                <!--Full Slide Bar-->
                <td style="height: 50px; text-align: center; margin: 0 0 0 0;" class="fullSlide">
                    <div class="bd">
                        <ul style="position: relative; width: 0px; height: 200px;">
                            <li style="background: url(/files/image/1.jpg)  center 0px; position: absolute; width: 500px; left: 0px; top: 0px;"><a href="javascript:;"></a></li>
                            <li style="background: url(/files/image/2.jpg)  center 0px; position: absolute; width: 500px; left: 0px; top: 0px; display: none;"><a href="javascript:;"></a></li>
                            <li style="background: url(/files/image/3.jpg)  center 0px; position: absolute; width: 500px; left: 0px; top: 0px; display: none;"><a href="javascript:;"></a></li>
                            <li style="background: url(/files/image/4.jpg)  center 0px; position: absolute; width: 500px; left: 0px; top: 0px; display: none;"><a href="javascript:;"></a></li>
                        </ul>
                    </div>
                    <div class="hd">
                        <ul>
                        ...
                        <ul id="games">
                            ...
                            <table>
                                ...
                                <tr style="display:">
                                    ...
                                    <td>
                                        <img style="vertical-align: top;transform: scale(0.7);" alt="" src="/files/image/333.gif" />
                                    </td>
                                    <td>
                                        <li><a href="javascript:GoUrl(3);" class="index_c1_ico4">六合彩</a></li>
                                    </td>
                                    <td>
                                        <img style="vertical-align: top;transform: scale(0.7);" alt="" src="/files/image/443.gif" />
                                    </td>
                                </tr>
                            </table>
                        </ul>
